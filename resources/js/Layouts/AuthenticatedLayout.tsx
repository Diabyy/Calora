                        ...
                        <div className="flex">
                            <div className="flex shrink-0 items-center">
                                <Link href="/dashboard" className="flex items-center gap-2">
                                    <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-600 to-teal-500 font-black text-white text-lg shadow-sm">
                                        C
                                    </span>
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink
                                    ...
                                    active={route().current('nutrition.*')}
                                >
                                    Nutrition & AI 📷
                                </NavLink>
                                <NavLink
